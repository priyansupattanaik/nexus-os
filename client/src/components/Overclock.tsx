...
export default function Overclock() {
  ...
  return (
    <div className="flex flex-col h-full p-6 items-center justify-between bg-black/20">
      {/* Presets */}
      ...
      {/* Big Timer */}
      <div
        className={`text-6xl font-mono font-bold tracking-tighter ${isOverclockActive ? "text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-violet-400 animate-pulse" : "text-slate-500"}`}
      >
        {formatTime(timeLeft)}
      </div>
